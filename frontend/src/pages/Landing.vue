  ...
  <div class="min-h-screen bg-white dark:bg-gray-950 text-gray-800 dark:text-gray-100">
    ...
    <section class="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
      <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div>
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 text-green-400 text-xs font-medium mb-4 sm:mb-6">
          ...
          <div class="flex flex-wrap items-center gap-4 sm:gap-6 mt-8 sm:mt-10 text-sm text-gray-500">
    ...
    <!-- AI Chat Widget (public mode for visitors) -->
...
const features = [
  {
    ...
    bg: 'bg-orange-100', icon_color: 'text-orange-600', bg_dark: 'bg-orange-500/10', icon_color_dark: 'text-orange-400',
  ...
  },
  {
    ...
    bg: 'bg-green-100', icon_color: 'text-green-600', bg_dark: 'bg-green-500/10', icon_color_dark: 'text-green-400',
  ...
  },
  {
    ...
    bg: 'bg-blue-100', icon_color: 'text-blue-600', bg_dark: 'bg-blue-500/10', icon_color_dark: 'text-blue-400',
  ...
  },
  {
    ...
    bg: 'bg-purple-100', icon_color: 'text-purple-600', bg_dark: 'bg-purple-500/10', icon_color_dark: 'text-purple-400',
  ...
  },
  {
    ...
    bg: 'bg-amber-100', icon_color: 'text-amber-600', bg_dark: 'bg-amber-500/10', icon_color_dark: 'text-amber-400',
  ...
  },
  {
    ...
    bg: 'bg-red-100', icon_color: 'text-red-600', bg_dark: 'bg-red-500/10', icon_color_dark: 'text-red-400',
  ...
  },
  {
    ...
    bg: 'bg-cyan-100', icon_color: 'text-cyan-600', bg_dark: 'bg-cyan-500/10', icon_color_dark: 'text-cyan-400',
  ...
  },
  {
    ...
    bg: 'bg-gray-100', icon_color: 'text-gray-600', bg_dark: 'bg-gray-500/10', icon_color_dark: 'text-gray-400',
  ...
  },
  {
    ...
    desc: 'Built-in AI assistant that knows your data. Ask questions, report bugs with screenshots, get instant answers 24/7.',
    bg: 'bg-violet-100', icon_color: 'text-violet-600', bg_dark: 'bg-violet-500/10', icon_color_dark: 'text-violet-400',
