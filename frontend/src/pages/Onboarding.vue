  ...
  <div class="min-h-screen bg-gray-950 text-gray-100">
    ...
    <div class="max-w-2xl mx-auto px-6 pb-12">
      ...
      <div v-if="step === 3">
        ...
        <!-- Next / Skip (hide when success card has its own Continue) -->
        <div v-if="!importResult" class="mt-6 flex items-center justify-between">
          ...
          <button v-if="manualPlanCreated" @click="nextStep" class="px-6 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-white font-semibold transition-colors">
            Continue
          </button>
        </div>
      </div>
